...
# ## Load stimuli
dirhc    = Path('/loctmp2/vog20246/BubblesDNN/dsetComposite/happyCorrect/')
dirhnc   = Path('/loctmp2/vog20246/BubblesDNN/dsetComposite/happyNeutralCorrect/')
#ddirfemale = Path('D:/BubblesDNN2/mfpics/female')
#ddir       = Path('D:/BubblesDNN2/mfpics/')
ddir       = Path('/loctmp2/vog20246/BubblesDNN/dsetComposite/')
...
# all_db_classes gibt klassen, hier 8
# random split 
...
#torch.save(model_trained.state_dict(), 'C:/Users/LocalAdmin/Documents/Git/BubblesLRP/scripts/models/pytorch/weights_splitdComposite.h5')
